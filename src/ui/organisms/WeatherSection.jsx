...
export const WeatherSection = () => {
  ...
  return (
    ...
    sl:w-[500px] sl:h-[300px] sl:gap-[30px]
    md:w-[340px] md:gap-[0px] md:h-[500px]
    lg:w-[490px] lg:h-[300px] lg:gap-[10px]
    xl:w-[845px] xl:flex-row xl:justify-between xl:px-[50px]
    " 
    style={{ backgroundColor: cardColor }}>
      ...
      sl:flex-row sl:gap-[30px]
      md:flex-col md:gap-[10px] md:mt-[30px]
      lg:flex-row lg:gap-[30px] lg:mt-0
      ">
      ...
      <div className="
        flex flex-col justify-start items-center order-[-1]
        xl:order-[1]
        ">
